...
void addAirport(Airport new_airport, Airport airportBank[MAX_AIRPORTS], int n_airports){ //[[airport, voosPartida, voosChegada], ...]
...
int notDuplicateAirport(char airportID[], Airport airportBank[MAX_AIRPORTS], int n_airports){
